  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fbff] p-6">
      <div className="max-w-md w-full bg-white rounded-xl border border-[#caf0f8] p-8 text-center shadow-sm">
        ...
        <h2 className="text-lg font-medium text-black mb-2">Live session error</h2>
        <p className="text-sm text-black/60 mb-6">{error.message || "The live interview session encountered an error."}</p>
        <div className="flex gap-3 justify-center">
          ...
          <a
            href="/"
            className="px-6 py-2.5 bg-[#caf0f8] hover:bg-[#ade8f4] text-black text-sm rounded-lg transition-colors"
          >
            Back to Home
          </a>
        </div>
