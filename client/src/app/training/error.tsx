  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fbff] p-6">
      <div className="max-w-md w-full bg-white rounded-xl border border-[#caf0f8] p-8 text-center shadow-sm">
        ...
        <h2 className="text-lg font-medium text-black mb-2">Training error</h2>
        <p className="text-sm text-black/60 mb-6">{error.message || "The training session encountered an error."}</p>
        <button
          onClick={reset}
